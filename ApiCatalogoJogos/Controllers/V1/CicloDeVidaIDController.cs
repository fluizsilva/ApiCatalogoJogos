...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    public class CicloDeVidaIDController : ControllerBase
    {
        ...
        public CicloDeVidaIDController(IExemploSingleton exemploSingleton1,
                                       ...
                                       IExemploTransient exemploTransiant1,
                                       IExemploTransient exemploTransiant2)
        {
            ...
            _exemploTransient1 = exemploTransiant1;
            _exemploTransient2 = exemploTransiant2;
        ...
        public class ExemploCicloVida : IExemploSingleton, IExemploScoped, IExemploTransient
        {
            private readonly Guid _guid;

            public ExemploCicloVida()
            {
                _guid = Guid.NewGuid();
            }
